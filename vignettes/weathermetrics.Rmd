...
For example, the `puravida` dataset gives daily values of wind speed in miles per hour (`beijing$MPH`) for San José, Costa Rica, for the week of August 2, 2015. To convert daily wind speed values from miles per hour to meters per second, in knots for this dataset, use the `speed.to.knots` function:
